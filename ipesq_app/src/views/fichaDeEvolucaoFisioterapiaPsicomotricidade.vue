<template>
    ...
    <v-col class="d-flex justify-start align-center">
        <span class="mx-2 flex-grow-0">Recursos  utilizados </span> 
        <v-textarea
        class="mx-4 "
        :items="itensDeUso"
...
const salvar = (async ()=>{
    ...
    let body = {  
        dataAplicacao: hoje,
        nomeForm: "FICHA DE EVOLUÇÃO FISIOTERAPIA/PSICOMOTRICIDADE",
...
const itensCondutas = ref([
    ...
    'Treino de coordenação motora global',
    'Mobilização',
    'Treino de equilíbrio',
    'Treino de lateralidade',
    'Treino de organização espacial e temporal',
    'Treino de esquema corporal',
